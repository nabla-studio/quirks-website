...
function ConnectHero() {
  return (
    <div className="relative flex min-h-[551px] w-full flex-col items-center justify-center self-center rounded-std bg-gradient-to-b from-primary to-connect-wallet-b">
